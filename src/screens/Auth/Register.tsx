...
export const Register = (): JSX.Element => {
  ...
  const EU_COUNTRIES = ['FI', 'SE', 'NO', 'DK', 'EE', 'LV', 'LT'];
    ...
    <Layout>
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="mb-8">
            <h2 className="text-xl font-medium mb-2">Create your account</h2>
            <p className="text-gray-600 mb-6">Join our community to share or receive food</p>
          ...
          {error && <div className="bg-red-50 border border-red-200 rounded-lg p-4 mt-4">
            <p className="text-red-600 text-sm">{error}</p>
          </div>}

          {currentStep > 0 && <div className="space-y-4 pt-4">

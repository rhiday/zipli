  ...
  return (
    <Layout>
      <div className="p-6">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-medium mb-2">Item details</h2>
          <p className="text-gray-600 mb-6">Take photos of your food items</p>
          ...
          <button
            ...
            className="text-sm text-gray-700 font-semibold hover:underline mt-8 block"
          >
            <div className="flex items-center gap-2">
              <Camera className="w-4 h-4" />
              <span>Unable to take photos? Type manually instead</span>
            </div>
          </button>
